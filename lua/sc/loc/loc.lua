...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_rip_desc_sc"] = "Fires a single poisoned slug that penetrates body armor. Deals poison damage over time.",
...
--[[   SKILLTREES   ]]--
	...
	--}
		...
		["bm_menu_skill_locked_x_judge"] = "Requires the Ambidexterity skill.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck4_9_desc_sc"] = "Dodging an attack causes you to regenerate ##1## health every ##2## seconds for the next ##20## seconds. This effect can stack an ##infinite## number of times, but all stacks are lost whenever you take health damage.\n\nDeck completion Bonus: Your chance of getting a higher quality item during PAYDAY is increased by ##10%.##",
