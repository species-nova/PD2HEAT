...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["RestorationModInfo_grinderDescID"] = "Enables or disables tracking of this specific perk deck ability.",
		["RestorationModInfo_infiltratorTitleID"] = "Life Drain (Infiltrator)",
		["RestorationModInfo_infiltratorDescID"] = "Enables or disables tracking of this specific perk deck ability.",
		...
		["RestorationModInfo_survive_one_hitDescID"] = "Enables or disables tracking of this specific perk deck ability.",
		...
		["RestorationModHolidayDescID"] = "Enable or disable Holiday effects for Heat.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_grenade_launcher_electric_arbiter_desc_sc"] = "Fires a round that causes a burst of electricity at point of impact. The burst deals 200 damage, has a radius of 2.5 meters, and has a chance to tase enemies.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deckall_2_desc_sc"] = "You do ##25%## more damage. Does not apply to throwables, grenade launchers, or rocket launchers.",
		["menu_deckall_4_desc_sc"] = "You do an additional ##25%## more damage. Does not apply to throwables, grenade launchers, or rocket launchers.",
		["menu_deckall_6_desc_sc"] = "You do an additional ##25%## more damage. Does not apply to throwables, grenade launchers, or rocket launchers.",
		["menu_deckall_8_desc_sc"] = "You do an additional ##25%## more damage. Does not apply to throwables, grenade launchers, or rocket launchers.",
