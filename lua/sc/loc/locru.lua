...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Weapons", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_w_mossberg590"] = "Дробовик Reinbeck 890",
		["bm_w_mossberg590_desc"] = "Наследник самого популярного дробовика банды. От оригинального Reinbeck осталась убойная сила, но дизайн был немного изменён: Его легче заряжать, но он менее стабилен.",
