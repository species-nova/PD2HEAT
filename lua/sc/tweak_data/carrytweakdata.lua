local orig_init = CarryTweakData.init
function CarryTweakData:init(...)
	...
	self.types.coke_light.move_speed_modifier = 0.9
	self.types.coke_light.jump_modifier = 0.9
	...
	self.types.light.jump_modifier = 0.9
	...
	self.types.medium.jump_modifier = 0.75
	...
	self.types.explosives.move_speed_modifier = 0.75
	self.types.explosives.jump_modifier = 0.75
	self.types.explosives.can_run = false
	self.types.explosives.throw_distance_multiplier = 0.85	
	
	self.types.cloaker_explosives.move_speed_modifier = 0.75
	self.types.cloaker_explosives.jump_modifier = 0.75
	...
	self.types.slightly_heavy.jump_modifier = 0.6
	...
	self.types.slightly_very_heavy.move_speed_modifier = 0.45
	self.types.slightly_very_heavy.jump_modifier = 0.45
	self.types.slightly_very_heavy.can_run = false
	self.types.slightly_very_heavy.throw_distance_multiplier = 0.55
	
	self.types.very_heavy.move_speed_modifier = 0.45
	self.types.very_heavy.jump_modifier = 0.45
