...
function WeaponTweakData:_init_stats()
	...
	--STABILITY
		...
		--Note: Recoil is multiplied based on the gun's base fire rate (sqrt(base delay between bullets))
	...
	self.stat_info.kick_tables = {
		...
		horizontal_recoil =       {0.6, 0.4, -1.2, 1.2},
		horizontal_left_recoil =  {0.6, 0.5, -1.7, 0.6},
		horizontal_right_recoil = {0.6, 0.5, -0.6, 1.7},
		even_recoil =             {0.8, 0.6, -1.0, 1.0},
		left_recoil =             {0.8, 0.6, -1.5, 0.5},
		right_recoil =            {0.8, 0.6, -0.5, 1.5},
		moderate_kick =           {1.0, 0.8, -0.8, 0.8},
		moderate_left_kick =      {1.0, 0.8, -1.2, 0.4},
		moderate_right_kick =     {1.0, 0.8, -0.4, 1.2},
		vertical_kick =           {1.5, 1.3, -0.3, 0.3},
		left_kick =               {1.5, 1.3, -0.5, 0.1},
		right_kick =              {1.5, 1.3, -0.1, 0.5}
	}
