...
function WeaponTweakData:_init_stats()
	...
	--ACCURACY
		...
		self.stat_info.spread_per_accuracy = -0.3
		self.stats.spread = {}
		for i = 0, 20, 1 do
	...
	--MOBILITY
		...
		self.stat_info.spread_per_mobility = -0.45
	...
	--STABILITY
		...
		self.stat_info.spread_per_stability = -0.45 --Amount bloom spread is reduced by stability.
