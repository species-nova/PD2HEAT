...
function PlayerMovement:init(...)
	...
	self._has_underdog = player_manager:has_category_upgrade("shotgun", "close_combat_damage_boost")
		...
		or player_manager:has_category_upgrade("shotgun", "close_combat_draw_speed_multiplier")
		or player_manager:has_category_upgrade("weapon", "close_combat_holster_speed_multiplier")
