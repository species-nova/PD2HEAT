...
function GroupAIStateBesiege:_upd_assault_task()
	...
	if task_data.phase == "anticipation" then
		...
		elseif task_data.phase_end_t < t or self._drama_data.zone == "high" and not low_carnage then --if drama is high and there are 5 or more enemies engaging all players, start the assault and drop the bass
