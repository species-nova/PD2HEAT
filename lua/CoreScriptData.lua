...
Hooks:Add("BeardLibCreateScriptDataMods", "SCLECallBeardLibSequenceFuncs", function()
	if Global.load_level == true then 
		...
		elseif level_id == "glace" then --Green Bridge
			BeardLib:ReplaceScriptData(mod_path .. "scriptdata/env_glace_ext.custom_xml", "custom_xml", "environments/pd2_glace/pd2_glace_outside", "environment")
			BeardLib:ReplaceScriptData(mod_path .. "scriptdata/env_glace_int.custom_xml", "custom_xml", "environments/pd2_glace/pd2_glace_inside", "environment")
